            ...
            <div class="space-y-6 pt-2">
                <div class="flex items-center ml-1">
                    <input id="remember_me" type="checkbox" name="remember"
                        class="w-4 h-4 rounded border-slate-300 text-[#6366f1] focus:ring-[#6366f1]">
                    <label for="remember_me" class="ms-2 text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest cursor-pointer">
                        Ingat saya
                    </label>
                </div>

                <button type="submit"
                    class="w-full py-4 bg-slate-900 dark:bg-white text-white dark:text-black font-black rounded-2xl hover:bg-[#6366f1] dark:hover:bg-indigo-500 hover:text-white transition-all duration-300 shadow-xl shadow-indigo-500/10 uppercase tracking-widest text-xs">
                    Log In
                </button>
            </div>
        </form>
