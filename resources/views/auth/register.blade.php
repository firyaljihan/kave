    ...
    <div class="min-h-screen flex items-center justify-center bg-white dark:bg-slate-950 px-6 py-12 transition-colors duration-300">
        <div class="w-full max-w-lg bg-white dark:bg-slate-900/50 rounded-[2.5rem] p-10 shadow-2xl shadow-indigo-500/10 border border-slate-100 dark:border-white/5 backdrop-blur-xl">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div class="pt-4">
                    <button type="submit" class="w-full py-4 bg-slate-900 dark:bg-white text-white dark:text-black font-black rounded-2xl hover:bg-[#6366f1] dark:hover:bg-indigo-500 hover:text-white transition-all duration-300 shadow-xl shadow-indigo-500/10 active:scale-[0.98] uppercase tracking-[0.1em]">
                        Daftar Akun
                    </button>
                </div>
