<x-app-layout>
    <div class="min-h-screen py-12 flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900 px-4">
        ...
        <div class="w-full max-w-4xl bg-white dark:bg-slate-800 rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[500px] relative">
            ...
            {{-- BAGIAN KIRI: GAMBAR & JUDUL (Lebar 35%) --}}
            <div class="w-full md:w-[35%] relative bg-slate-900 h-64 md:h-auto overflow-hidden">
                ...
                {{-- Decorative Circles (Sobekan Tiket Kiri - Hiasan) --}}
                ...
                <div class="absolute inset-0 p-10 flex flex-col justify-between text-white z-0">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-sm font-bold truncate opacity-90">{{ $ticket->event->user->name ?? 'Panitia Event' }}</span>
                        </div>
                    </div>
                </div>
            </div>

            {{-- BAGIAN KANAN: DETAIL TIKET (Lebar 65%) --}}
                ...
                <div class="flex flex-col md:flex-row gap-10">
                    ...
                    <div class="flex-1 space-y-6">
                        ...
                        <div>
                            ...
                            <a href="https://maps.google.com/?q={{ urlencode($ticket->event->location) }}" target="_blank" class="text-xs font-bold text-indigo-500 hover:text-indigo-600 inline-flex items-center gap-1 mt-1">
